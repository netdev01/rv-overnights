...
// bubble_fn_blocked_dates({datesYearly: result.datesYearly, datesNotYearly: result.datesNotYearly});  // js2b element named 'blocked_dates' with outputs datesYearly, datesNotYearly
