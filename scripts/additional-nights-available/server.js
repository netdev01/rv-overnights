// Bubble server wrapper: only run when properties is supplied by Bubble runtime
if (typeof properties !== 'undefined' && properties && typeof properties.thing1 !== 'undefined') {
...
// Export the function for Node tests
